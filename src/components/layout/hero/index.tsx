...
function TypeHeroLogo3D() {
  return (
    ...
    >
      ...
      <g
        className="animate-3d-logo hidden dark:block"
        filter="url(#filter0_ii_1050_32)"
      >
        <path
          d="M0 74.9605C0 33.561 33.561 0 74.9605 0H558.039C599.439 0 633 33.561 633 74.9605V558.039C633 599.439 599.439 633 558.039 633H74.9605C33.561 633 0 599.439 0 558.039V74.9605Z"
          fill="#8b5cf6"
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            mode="normal"
            in2="shape"
            result="effect1_innerShadow_1050_32"
          />
          <feColorMatrix
            in="SourceAlpha"
            type="matrix"
      ...
      <div className="container relative grid min-h-screen items-center justify-center py-24 lg:min-h-0 lg:grid-cols-2 lg:py-0">
        ...
        <div className="flex w-full flex-col items-center justify-center gap-10 lg:items-start">
          <a
            ...
            className="animate-bg-gradient-to-center group rounded-full bg-gradient-to-r from-yellow-600 via-[#8b5cf6] to-[#8b5cf6] to-70% bg-[length:420%_420%] bg-right-bottom p-[1px] brightness-90 contrast-150 duration-500 hover:bg-left-top hover:shadow-[0_0_2rem_-0.5rem_#8b5cf6] dark:from-yellow-500 dark:via-white dark:to-[#8b5cf6] dark:brightness-125 dark:contrast-100 dark:hover:shadow-[0_0_2rem_-0.5rem_#fff8]"
          >
